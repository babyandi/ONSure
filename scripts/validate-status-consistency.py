...
def main() -> int:
    ...
    if len(sub_items) != 38 or len(sub_ids) != 38:
    ...
    sub_by_id = {item.get("id"): item for item in sub_items}
    partial = sub_by_id.get("FR-04-C", {})
    ...
    if workflow_status.get("dispatcher_operation_count") != 39:
