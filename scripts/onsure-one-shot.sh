...
static-only Tracked source, structured contracts, granular requirements, critical callpaths, surface parity, links and shell syntax.
EOF
      exit 0
      ;;
...
body = {
    "contract": "ONSURE_ONE_SHOT_RESULT_V7",
    "decision": "FAIL",
    "profile": profile,
    "failure": failure,
...
body = {
    "contract": "ONSURE_ONE_SHOT_STEP_RECEIPT_V7",
    "step": step,
    "started_at": started,
...
body = {
    "contract": "ONSURE_ONE_SHOT_ENVIRONMENT_V6",
