...
def main()->int:
    ...
    result={'contract':'ONSURE_SUCCESSOR_PREMERGE_READINESS_V2','required_dd_count':42,'required_human_decision_denominator':22,'blocking_reasons':sorted(set(reasons)),'ready_for_main_merge':not reasons,'decision':'READY_FOR_MAIN_MERGE_NONFINAL' if not reasons else 'HOLD_NONFINAL','evidence':evidence,'main_merge_allowed':not reasons,'design_lock':False,'final_claim_allowed':False}
