...
def validate() -> list[str]:
    ...
    for section in (
        "design_coverage", "legacy_product_decomposition", "legacy_mvp_acceptance",
        "final_product_requirement_coverage", "final_acceptance_coverage",
    ...
    mvp_status = status.get("legacy_mvp_acceptance", {})
    if mvp_status.get("state") != "LEGACY_ALL_NOT_RUN":
...
def main() -> int:
    ...
    if errors:
        ...
        return 1
    print("ONSURE_VERIFICATION_CLAIM_AUDIT_PASS", file=sys.stderr)
    return 0
