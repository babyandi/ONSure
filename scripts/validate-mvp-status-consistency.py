...
def main() -> int:
    ...
    status = verification.get("legacy_mvp_acceptance", {})
    ...
    if count_values.get("legacy_mvp_acceptance_cases") != 8:
    ...
    if additional.get("legacy_mvp_acceptance_cases") != count_values.get("legacy_mvp_acceptance_cases"):
    ...
    if status_failure.get("legacy_mvp_acceptance_cases") != count_values.get("legacy_mvp_acceptance_cases"):
    ...
    report = {
        ...
        "mvp_acceptance_failure_injections": count_values.get("legacy_mvp_acceptance_cases"),
    ...
    if errors:
        ...
        return 1
    print("ONSURE_MVP_STATUS_CONSISTENCY_PASS", file=sys.stderr)
    return 0
