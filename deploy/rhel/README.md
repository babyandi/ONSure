...
the ONSure loopback API under systemd and optional outbound HTTPS to the OpenAI Responses API.
...
- `/etc/systemd/system/{onsure,onsure-migrate}.service`: supplied candidate units
