...
3. `docs/master/02_FUNCTIONAL_REQUIREMENTS_AND_PROGRAMS.md`
4. `docs/05_PRODUCT_REQUIREMENTS_AND_ACCEPTANCE.md`
5. `docs/07_CORE_ARCHITECTURE_AND_STATE_MODEL.md`
